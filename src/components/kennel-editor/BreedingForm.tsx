    ...
    <form action={formAction} className="space-y-6 pb-28">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="space-y-1.5">
          ...
          <input
            ...
            name="sire_name"
            defaultValue={breeding?.sire_name ?? ""}
            className={inputClass}
          />
        </div>
        <div className="space-y-1.5">
          ...
          <input
            id={fieldId("dam_name")}
            name="dam_name"
            defaultValue={breeding?.dam_name ?? ""}
            className={inputClass}
          />
        </div>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          defaultValue={breeding?.description ?? ""}
          className={inputClass}
        />
      </div>
